// ==UserScript==
// @name         Gemini Counter Ultimate (v7.3-debug)
...
(function () {
    ...
    console.log("💎 Gemini Assistant v7.3-debug (Modular - Pure Enhancement) Starting...");
    ...
    const PanelUI = {
        ...
        openSettingsModal() {
            ...
            version.textContent = 'Gemini Assistant v7.3-debug (Modular)';
        ...
        openDebugModal() {
            ...
            const renderLogs = () => {
                ...
                const entries = Logger.getEntries().slice(-80);
                if (entries.length === 0) {
                ...
                entries.forEach(e => {
                    ...
                    const meta = `${e.ts} [${e.level.toUpperCase()}]`;
                    const data = e.data ? ` ${JSON.stringify(e.data)}` : '';
                    item.textContent = `${meta} ${e.msg}${data}`;
